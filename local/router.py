...
CERT_PATH = os.getenv("CERT_PATH", "../final-cert/new-quic.crt")
KEY_PATH = os.getenv("KEY_PATH", "../final-cert/new-quic.key")
CONFIG_PATH = os.getenv("CONFIG_PATH", "router_config.yaml")
