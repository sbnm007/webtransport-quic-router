...
#These will be populated by the MicroserviceConfigManager from the mounted config file
PULSAR_BROKER_URL = None
SEND_TO_PULSAR = False
MICROSERVICE_CONFIG_PATH = os.getenv("MICROSERVICE_CONFIG_PATH", "/config/microservice_config.yaml")
